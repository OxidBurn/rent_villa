...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 px-4 py-5 md:px-8 lg:px-12 transition-all duration-300 ${
    ...
    >
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-6 lg:gap-12">
          ...
          <Link
            href="/about"
            className={`uppercase text-sm font-normal hover:opacity-80 transition-all ${
              isScrolled ? 'text-[#06272d]' : 'text-white'
            }`}
          >
            О нас
        ...
        <div className="flex items-center gap-3 lg:gap-4">
          <div
            className={`px-3 lg:px-4 py-3 rounded-xl bg-white/[0.14] backdrop-blur-md uppercase text-sm font-normal transition-colors ${
              isScrolled ? 'text-[#06272d]' : 'text-white'
            }`}
          >
            RU
